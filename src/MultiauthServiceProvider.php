...
use Moeen\Multiauth\Console\Commands\Install;
use Moeen\Multiauth\Console\Commands\RoleCmd;
use Moeen\Multiauth\Console\Commands\SeedCmd;
use Moeen\Multiauth\Exception\MultiAuthHandler;
use Moeen\Multiauth\Http\Middleware\AdminPermitTo;
use Moeen\Multiauth\Providers\AuthServiceProvider;
use Moeen\Multiauth\Console\Commands\PermissionCommand;
use Moeen\Multiauth\Http\Middleware\AdminPermitToParent;
use Moeen\Multiauth\Console\Commands\MakeMultiAuthCommand;
use Moeen\Multiauth\Console\Commands\RollbackMultiAuthCommand;
use Moeen\Multiauth\Http\Middleware\redirectIfAuthenticatedAdmin;
use Moeen\Multiauth\Http\Middleware\redirectIfNotWithRoleOfAdmin;
...
class MultiauthServiceProvider extends ServiceProvider
{
    ...
    {
        return [
            'namespace'  => "Moeen\Multiauth\Http\Controllers",
            'middleware' => 'web',
